package com.example.crime_intent.controller;
...
public class SwipeRecyclerView implements RecyclerView.OnItemTouchListener {
    private int mSlop;
    ...
    public SwipeRecyclerView(RecyclerView recyclerView, SwipeListener listener) {
